"""
Sentinel Mouse Anomaly Model

River-based online learning anomaly detection for mouse dynamics.
...
class MouseAnomalyModel:
    """
    Anomaly detection model for mouse biometrics with explainability.
    
    Uses a pipeline of MinMaxScaler -> HalfSpaceTrees for
    online learning anomaly detection on mouse movement features.
    ...
    def __init__(self) -> None:
        """Initialize the mouse anomaly detection pipeline."""
    ...
    def score_one(self, features: Dict[str, float]) -> Tuple[float, List[str]]:
        ...
        Args:
            features: Dictionary of mouse features (e.g., speed_mean,
                      acceleration_mean, jerk_mean, efficiency, etc.)
    ...
    def learn_one(self, features: Dict[str, float]) -> None:
        ...
        Args:
            features: Dictionary of mouse features to learn from.
        """
        # Update pipeline
